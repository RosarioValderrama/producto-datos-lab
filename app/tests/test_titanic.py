...
TEST_DATA_PATH = os.getenv("TEST_DATA_PATH", "app/data/titanic_test_base.csv")

# Permite forzar umbral por env var (si no, 0.5)
...
def load_model_and_meta():
    ...
    # Caso antiguo (artefacto dict) → lo soportamos igual
